...
if ( ! function_exists( 'incc_post_format_setup' ) ) :
	/**
	 * Declares support for the post formats used by this theme.
	 */
	function incc_post_format_setup() {
		add_theme_support(
			'post-formats',
...
add_action( 'after_setup_theme', 'incc_post_format_setup' );


if ( ! function_exists( 'incc_editor_style' ) ) :
	/**
	 * Loads the editor stylesheet so the editing canvas matches the front end.
	 */
	function incc_editor_style() {
		add_editor_style( 'assets/css/editor-style.css' );
	}
endif;
add_action( 'after_setup_theme', 'incc_editor_style' );
