...
<div <?php echo $wrapper_attributes; ?>>
	<div class="incc-social-share__icons">

		<?php if ( $show_copy_link ) : ?>
		<button
			class="incc-social-share__item is-copy-link"
			aria-label="<?php esc_attr_e( 'Copy link', 'insignia-capital-corp' ); ?>"
		...
		<a
			class="incc-social-share__item is-linkedin"
			href="<?php echo esc_url( $linkedin_url ); ?>"
			target="_blank"
			rel="noopener noreferrer"
			aria-label="<?php esc_attr_e( 'Share on LinkedIn', 'insignia-capital-corp' ); ?>"
		>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
		...
		<?php if ( $show_twitter ) : ?>
		<a
			class="incc-social-share__item is-twitter"
			href="<?php echo esc_url( $twitter_url ); ?>"
			target="_blank"
			rel="noopener noreferrer"
			aria-label="<?php esc_attr_e( 'Share on X', 'insignia-capital-corp' ); ?>"
		>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
		...
		<a
			class="incc-social-share__item is-facebook"
			href="<?php echo esc_url( $facebook_url ); ?>"
			target="_blank"
			rel="noopener noreferrer"
			aria-label="<?php esc_attr_e( 'Share on Facebook', 'insignia-capital-corp' ); ?>"
		>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
