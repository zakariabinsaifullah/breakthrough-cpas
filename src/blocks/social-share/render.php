...
<div <?php echo $wrapper_attributes; ?>>
	<div class="btcpa-social-share__icons">

		<?php if ( $show_copy_link ) : ?>
		<button
			class="btcpa-social-share__item is-copy-link"
			aria-label="<?php esc_attr_e( 'Copy link', 'breakthrough-cpas' ); ?>"
		...
		<a
			class="btcpa-social-share__item is-linkedin"
			href="<?php echo esc_url( $linkedin_url ); ?>"
			target="_blank"
			rel="noopener noreferrer"
			aria-label="<?php esc_attr_e( 'Share on LinkedIn', 'breakthrough-cpas' ); ?>"
		>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
		...
		<?php if ( $show_twitter ) : ?>
		<a
			class="btcpa-social-share__item is-twitter"
			href="<?php echo esc_url( $twitter_url ); ?>"
			target="_blank"
			rel="noopener noreferrer"
			aria-label="<?php esc_attr_e( 'Share on X', 'breakthrough-cpas' ); ?>"
		>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
		...
		<a
			class="btcpa-social-share__item is-facebook"
			href="<?php echo esc_url( $facebook_url ); ?>"
			target="_blank"
			rel="noopener noreferrer"
			aria-label="<?php esc_attr_e( 'Share on Facebook', 'breakthrough-cpas' ); ?>"
		>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
