...
const FORMAT_NAME = 'btcpa/highlight';
const BASE_CLASS = 'btcpa-highlight';
 ...
 * holds only the modifier (e.g. `btcpa-highlight--600`).
 *
        ...
        <>
            ...
            <BlockControls group="other">
                <ToolbarButton
                    ...
                    label={__('Highlight', 'breakthrough-cpas')}
            ...
            {isOpen && (
                <Popover
                    ...
                    className="btcpa-highlight__popover"
                >
                    <div className="btcpa-highlight__panel">
                        <ToggleGroupControl
                            label={__('Font weight', 'breakthrough-cpas')}
                            value={activeWeight}
                        ...
                        >
                            {__('Remove highlight', 'breakthrough-cpas')}
                        </Button>
                    </div>
                </Popover>
            )}
...
const highlightFormat = {
    title: __('Highlight', 'breakthrough-cpas'),
    tagName: 'span',
